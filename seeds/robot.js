...
exports.seed = function(knex, Promise) {
 return knex('robot').del().then(function(){
  return Promise.join(
    ...
    knex('robot').insert({name: 'BB-8', alliance: "1", owner: 'Rey', description: 'round, orange, beeps', image: 'http://vignette2.wikia.nocookie.net/starwars/images/6/68/BB8-Fathead.png/revision/latest'})
